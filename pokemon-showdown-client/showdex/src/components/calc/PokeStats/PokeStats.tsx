          ...
          <ToggleButton
            ...
            onPress={() => {
              ...
              if (next) {
                ...
                // turning it off restores the format's max-EV assumption for Atk only
                evs.atk = getMaxStatEv(format);
                ivs.atk = 31;
              }

              updatePokemon({
                phnnMinConfusion: next,
                evs,
                ivs,
                ...(next && {
                  nature: getPhnnMinConfusionNature(pokemon?.nature, PokemonNatureBoosts),
                }),
