...
export const env = createEnvParser({
  ...
  INDEXED_DB_TELEDEX_STORE_NAME: process.env.INDEXED_DB_TELEDEX_STORE_NAME,
  ...
  TELEDEX_ENABLED: process.env.TELEDEX_ENABLED,
  TELEDEX_RETENTION_AGE: process.env.TELEDEX_RETENTION_AGE,
  TELEDEX_RETENTION_AGE_UNIT: process.env.TELEDEX_RETENTION_AGE_UNIT,
  TELEDEX_RETENTION_MAX: process.env.TELEDEX_RETENTION_MAX,
