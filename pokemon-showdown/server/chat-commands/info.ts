...
export const commands: Chat.ChatCommands = {
	...
	groups(target, room, user) {
		...
		const globalRanks = [
			...
			this.TL`& <strong>Global Leader</strong> - The above, and they make important decisions about the server`,
...
export const pages: Chat.PageTable = {
	...
	credits(query, user) {
		...
		return Utils.html`<div class="pad">
			...
			<ul>
				<li><p><a href="https://hackmons.com/" target="_blank" class="subtle"><strong>isleep2late</strong></a> <small>&ndash; Development, Sysadmin, Formats</small></p></li>
			</ul>
