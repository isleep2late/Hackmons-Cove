...
},
{
	...
	unbanlist: ['Past', 'Future', 'Unobtainable'],
	onBegin() {
		this.add('Gen 8 Pure Hackmons Unified. Gen 8 plus every BDSP Pokemon.');
	},
},
{
	...
	onBegin() {
		this.add('Gen 6 Pure Hackmons 510+. The 510 EV limit has been lifted! Pokemon can have 252 EVs in all 6 stats!');
	},
},
{
	name: "[Gen 4] Glitched Anything Goes",
	...
	onBegin() {
		this.add('Gen 4 Glitched Anything Goes. The Rage glitch lets Smeargle-reachable Pokemon learn any move (except Chatter and Struggle)!');
	},
},
{
...
{
	name: "[Gen 2] No Clerics",
	desc: "Gen 2 Pure Hackmons without the Cleric Clause - Pokemon can start the battle pre-statused.",
	mod: 'gen2',
	...
	onBegin() {
		this.add('Gen 2 No Clerics. No Cleric Clause - Pokemon can enter battle already statused!');
	},
},
{
