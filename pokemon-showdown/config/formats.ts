...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	{
		name: "[Gen 2] Statuses Doubles",
		desc: "Gen 2 Pure Hackmons in Doubles, but Pokemon can start the battle pre-statused.",
		mod: 'gen2doubles',
		gameType: 'doubles',
		searchShow: false,
		ruleset: ['-Nonexistent', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Max Level = 255', 'Default Level = 100'],
	...
	{
		name: "[Gen 1] Disguises Doubles",
		desc: "Gen 1 Pure Hackmons in Doubles, but Pokemon can have any type, disguise as any species, and even start the game pre-statused.",
		mod: 'gen1doubles',
		gameType: 'doubles',
		searchShow: false,
		ruleset: ['-Nonexistent', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Max Level = 255', 'Default Level = 100', 'Disguise Mod'],
	...
	{
		name: "[Gen 9] Custom Disguises Rotation",
		mod: 'gen9',
		gameType: 'rotation',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 9] Custom Disguises Infinite",
		mod: 'infinite',
		searchShow: false,
		debug: true,
		battle: {trunc: Math.trunc},
		ruleset: ['HP Percentage Mod', 'Cancel Mod', 'Max Team Size = 24', 'Max Move Count = 24', 'Max Level = 9999', 'Default Level = 100', 'Disguise Mod', 'Infinite Mod'],
	},
	{
		name: "[Gen 9] Custom Disguises Infinite Doubles",
		mod: 'infinite',
		gameType: 'doubles',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 9] Custom Disguises Infinite Triples",
		mod: 'infinite',
		gameType: 'triples',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 9] Custom Disguises Infinite Rotation",
		mod: 'infinite',
		gameType: 'rotation',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 9] Custom Disguises Infinite Multi",
		mod: 'infinite',
		gameType: 'multi',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 8] Custom Disguises Rotation",
		mod: 'gen8',
		gameType: 'rotation',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 7] Custom Disguises Rotation",
		mod: 'gen7',
		gameType: 'rotation',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 6] Custom Disguises Rotation",
		mod: 'gen6',
		gameType: 'rotation',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 5] Custom Disguises Rotation",
		mod: 'gen5',
		gameType: 'rotation',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 9 Champions] Custom Disguises Doubles",
		mod: 'champions',
		gameType: 'doubles',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 9 Champions] Custom Disguises Triples",
		mod: 'champions',
		gameType: 'triples',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 9 Champions] Custom Disguises Rotation",
		mod: 'champions',
		gameType: 'rotation',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 9 Champions] Custom Disguises Multi",
		mod: 'champions',
		gameType: 'multi',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 9 Champions] Custom Disguises Free-for-All",
		mod: 'champions',
		gameType: 'freeforall',
		searchShow: false,
		debug: true,
	...
	//////////////////////////////////
	////// Rotation Custom Game //////
	//////////////////////////////////
	{
		section: "Rotation Custom Game",
		column: 3,
	},
	{
		name: "[Gen 9] Rotation Custom Game",
		mod: 'gen9',
		gameType: 'rotation',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 8] Rotation Custom Game",
		mod: 'gen8',
		gameType: 'rotation',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 7] Rotation Custom Game",
		mod: 'gen7',
		gameType: 'rotation',
		searchShow: false,
		debug: true,
	...
	//////////////////////////////////
	{
		section: "Multi Custom Game",
		column: 3,
	},
	{
		name: "[Gen 9] Multi Custom Game",
		mod: 'gen9',
		gameType: 'multi',
		searchShow: false,
		debug: true,
	...
	//////////////////////////////////
	/// Free-for-All Custom Game /////
	//////////////////////////////////
	{
		section: "Free-for-All Custom Game",
		column: 3,
	},
	{
		name: "[Gen 9] Free-for-All Custom Game",
		mod: 'gen9',
		gameType: 'freeforall',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 7] Free-for-All Custom Game",
		mod: 'gen7',
		gameType: 'freeforall',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 6] Free-for-All Custom Game",
		mod: 'gen6',
		gameType: 'freeforall',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 5] Free-for-All Custom Game",
		mod: 'gen5',
		gameType: 'freeforall',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 4] Free-for-All Custom Game",
		mod: 'gen4',
		gameType: 'freeforall',
		searchShow: false,
		debug: true,
	...
	{
		name: "[Gen 3] Free-for-All Custom Game",
		mod: 'gen3',
		gameType: 'freeforall',
		searchShow: false,
		debug: true,
