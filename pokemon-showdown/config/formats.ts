...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		searchShow: false,
		challengeShow: false,
		ruleset: ['-Nonexistent', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Max Level = 255', 'Default Level = 100', 'Disguise Mod'],
	},
	{
	...
	},
	{
		...
		searchShow: false,
		challengeShow: false,
		ruleset: ['-Nonexistent', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Max Level = 255', 'Default Level = 100', 'Disguise Mod', 'EV Limit = 192', 'EV Limits = Atk 0-32 / Def 0-32 / SpA 0-32 / SpD 0-32 / Spe 0-32 / HP 0-32'],
		unbanlist: ['Past', 'Unobtainable'],
	},
	{
	...
	},
	{
		...
		searchShow: false,
		challengeShow: false,
		ruleset: ['-Nonexistent', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Max Level = 255', 'Default Level = 100', 'Prestatus', 'EV Limit = 192', 'EV Limits = Atk 0-32 / Def 0-32 / SpA 0-32 / SpD 0-32 / Spe 0-32 / HP 0-32'],
		unbanlist: ['Past', 'Unobtainable'],
	},
	{
	...
	},
	{
		...
		searchShow: false,
		challengeShow: false,
		ruleset: ['-Nonexistent', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Max Level = 255', 'Default Level = 100', 'EV Limit = 192', 'EV Limits = Atk 0-32 / Def 0-32 / SpA 0-32 / SpD 0-32 / Spe 0-32 / HP 0-32', 'Level Clause Mod'],
		unbanlist: ['Past', 'Unobtainable'],
	},
	{
	...
	},
	{
		...
		searchShow: false,
		challengeShow: false,
		ruleset: ['-Nonexistent', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Max Level = 255', 'Default Level = 100', 'Prestatus', 'No Move Exclusivity'],
		unbanlist: ['No Move-2'],
	},
	{
		name: "[Gen 2] Statuses",
	...
	},
	{
		...
		mod: 'spaceworld',
		searchShow: false,
		ruleset: ['-Nonexistent', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Max Level = 255', 'Default Level = 100', 'Prestatus', 'SpaceWorld Disguise Mod', 'No Move Exclusivity'],
