...
export const Moves: import('../sim/dex-moves').MoveDataTable = {
	...
	rockslash: {
		...
		desc: "Deals damage with no additional effect. This Rock-type move existed in the Gold and Silver development builds after the SpaceWorld 1997 demo but was cut before release; its development data lists 140 power and 70% accuracy.",
		pp: 5,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, metronome: 1 },
		secondary: null,
	...
	nomove2: {
		...
		name: "No Move-2",
		shortDesc: "The Gen 2 corrupted move. Badly poisons the target.",
		desc: "A replica of the corrupted move a Gen 2 Pokemon uses when it thaws or acts with move slot 0: Rapid Spin's animation, a glitch type, 52/256 (~20.3%) accuracy, and it badly poisons the target. Base power is 9 in Crystal and 5 in Gold/Silver.",
		pp: 33,
		noPPBoosts: true,
		priority: 0,
		flags: {},
	...
	nomovesw: {
		...
		isNonstandard: "Custom",
		name: "No Move-SW",
		shortDesc: "The Gen 2 SpaceWorld corrupted move. Huge power; MAY crash on hardware.",
		desc: "A replica of the corrupted move (move slot 0) in the 1997 Gold/Silver SpaceWorld demo. Unlike the final Gen 2 games, the demo places the EvolvePokemon code right after the move table, so move 0 reads into it: base power 214 (the high byte of wPartyCount's $D6AA WRAM address), ??? type, and 33/256 (~12.9%) accuracy. Its effect byte ($AA) is out of range, so on real SpaceWorld hardware this move likely CRASHES; here it is modeled as a raw 214-power ??? attack.",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: {},
	...
	nomove: {
		...
		desc: "A replica of the corrupted move a Gen 1 Pokemon uses when it thaws before its team has selected a move: Fissure's animation, 102 base power, ??? type, Special category, and 81/256 (~31.6%) accuracy.",
		pp: 10,
		priority: 0,
		flags: {},
		secondary: null,
	...
	naildown: {
		...
		isNonstandard: "Demo",
		name: "Nail Down",
		shortDesc: "User loses 1/4 max HP; curses the target.",
		desc: "The user drives a nail into itself, losing 1/4 of its maximum HP, and puts a curse on the target. This is the SpaceWorld 1997 demo's prototype of Ghost-type Curse; the 40 power in the demo's move data is never used by its battle script.",
		pp: 10,
		priority: 0,
		...
		onHit(target, source) {
			this.directDamage(this.clampIntRange(Math.floor(source.maxhp / 4), 1), source, source);
		},
		secondary: null,
		target: "normal",
		type: "Ghost",
	...
	coinhurl: {
		...
		isNonstandard: "Demo",
		name: "Coin Hurl",
		shortDesc: "The SpaceWorld 1997 demo's coin-throwing attack.",
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
		secondary: null,
	...
	synchronize: {
		...
		isNonstandard: "Demo",
		name: "Synchronize",
		shortDesc: "User changes type to match its first move.",
		desc: "The SpaceWorld 1997 demo gives this move Conversion's effect: the user's type changes to match one of its moves.",
		pp: 10,
		priority: 0,
		flags: { snatch: 1, metronome: 1 },
		onHit(target) {
			const possibleTypes = target.moveSlots.map(moveSlot => {
				const move = this.dex.moves.get(moveSlot.id);
				if (move.id !== 'synchronize' && !target.hasType(move.type)) {
					return move.type;
				}
				return '';
			}).filter(type => type);
	...
	bonelock: {
		...
		isNonstandard: "Demo",
		name: "Bone Lock",
		shortDesc: "The SpaceWorld 1997 demo's bone attack.",
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
		secondary: null,
	...
	bellchime: {
		...
		isNonstandard: "Demo",
		name: "Bell Chime",
		shortDesc: "Cures the user's status condition.",
		desc: "The SpaceWorld 1997 demo's prototype of Heal Bell: it cures the user's own status condition and nightmares, but does not affect the rest of the party.",
		pp: 10,
		priority: 0,
		flags: { snatch: 1, sound: 1, metronome: 1 },
		onHit(pokemon) {
	...
	rockhead: {
		...
		isNonstandard: "Demo",
		name: "Rock Head",
		shortDesc: "The SpaceWorld 1997 demo's heavy Rock attack.",
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
		secondary: null,
	...
	crosscutter: {
		...
		isNonstandard: "Demo",
		name: "Cross Cutter",
		shortDesc: "The SpaceWorld 1997 demo's scissor attack.",
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
		secondary: null,
	...
	uproot: {
		...
		isNonstandard: "Demo",
		name: "Uproot",
		shortDesc: "The SpaceWorld 1997 demo's uprooting attack.",
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
		secondary: null,
	...
	windride: {
		...
		isNonstandard: "Demo",
		name: "Wind Ride",
		shortDesc: "The SpaceWorld 1997 demo's wind-riding attack.",
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
		secondary: null,
	...
	strongarm: {
		...
		isNonstandard: "Demo",
		name: "Strong Arm",
		shortDesc: "The SpaceWorld 1997 demo's Steel-type punch.",
		pp: 10,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, punch: 1, metronome: 1 },
		secondary: null,
	...
	hm01: {
		...
		name: "HM01",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xC4. Cartridge effect: Lowers a random glitched stat. Only the damage is simulated here. Its real type is the glitch type 'None'. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	hm02: {
		...
		desc: "A replica of the Generation 1 glitch move 0xC5. Cartridge effect: Drains HP. Its real type is the glitch type 'None'.",
		pp: 29,
		noPPBoosts: true,
		priority: 0,
	...
	hm03: {
		...
		gen: 1,
		name: "HM03",
		shortDesc: "User gains 1/2 of the damage inflicted. Sleeping target only.",
		desc: "A replica of the Generation 1 glitch move 0xC6. Cartridge effect: Drains HP from a sleeping foe, identical to Dream Eater.",
		pp: 59,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, heal: 1 },
	...
	hm04: {
		...
		desc: "A replica of the Generation 1 glitch move 0xC7. Cartridge effect: Causes user to skip the next turn. Its real type is the glitch type 'Glitch'.",
		pp: 12,
		noPPBoosts: true,
		priority: 0,
		flags: { recharge: 1, protect: 1, mirror: 1, metronome: 1 },
	...
	hm05: {
		...
		name: "HM05",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xC8. Cartridge effect: No additional effect. Its real type is the glitch type 'Glitch'.",
		pp: 6,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm01: {
		...
		desc: "A replica of the Generation 1 glitch move 0xC9. Cartridge effect: Has a 30% chance of Poisoning the target.",
		pp: 3,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm02: {
		...
		gen: 1,
		name: "TM02",
		shortDesc: "Lowers the target's evasiveness by 2 stages.",
		desc: "A replica of the Generation 1 glitch move 0xCA. Cartridge effect: Lowers the target's Evasion by 2. Its real type is the glitch type 'None'.",
		pp: 11,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, reflectable: 1, mirror: 1, metronome: 1 },
	...
	tm03: {
		...
		name: "TM03",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xCB. Cartridge effect: No additional effect. Its real type is the glitch type 'None'.",
		pp: 57,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm04: {
		...
		desc: "A replica of the Generation 1 glitch move 0xCC. Cartridge effect: No effect.",
		pp: 39,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm05: {
		...
		gen: 1,
		name: "TM05",
		shortDesc: "Raises the user's evasiveness by 2 stages.",
		desc: "A replica of the Generation 1 glitch move 0xCD. Cartridge effect: Raises the user's Evasion 2 stages (Red/Blue, 33 PP). In Yellow: 76 BP, 30% acc, 21 PP, freezes the game. Its real type is the glitch type ',K Pk<player>xX'.",
		pp: 33,
		noPPBoosts: true,
		priority: 0,
		flags: { snatch: 1, metronome: 1 },
	...
	tm06: {
		...
		name: "TM06",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xCE. Cartridge effect: Freeze and/or messes up the game. Only the damage is simulated here.",
		pp: 127,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm08: {
		...
		gen: 1,
		name: "TM08",
		shortDesc: "User is hurt if it misses.",
		desc: "A replica of the Generation 1 glitch move 0xD0. Cartridge effect: When it misses, the user takes half damage. Its real type is the glitch type 'Glitch'.",
		pp: 20,
		noPPBoosts: true,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, metronome: 1 },
	...
	tm09: {
		...
		desc: "A replica of the Generation 1 glitch move 0xD1. Cartridge effect: The user faints after using it. Its real type is the glitch type 'IIIItoto'.",
		pp: 16,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm10: {
		...
		name: "TM10",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xD2. Cartridge effect: No additional effect. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm11: {
		...
		name: "TM11",
		shortDesc: "Does nothing.",
		desc: "A replica of the Generation 1 glitch move 0xD3. Cartridge effect: None. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm12: {
		...
		name: "TM12",
		shortDesc: "Does nothing.",
		desc: "A replica of the Generation 1 glitch move 0xD4. Cartridge effect: None.",
		pp: 7,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm13: {
		...
		name: "TM13",
		shortDesc: "Raises the user's evasiveness by 2 stages.",
		desc: "A replica of the Generation 1 glitch move 0xD5. Cartridge effect: Increases the user's Evasion by two stages.",
		pp: 10,
		noPPBoosts: true,
		priority: 0,
		flags: { snatch: 1, metronome: 1 },
	...
	tm14: {
		...
		name: "TM14",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xD6. Cartridge effect: If the move hits, the user's Pokémon's sprite disappears. Only the damage is simulated here. Its real type is the glitch type 'Qi JT<name of player>? POké BB<name of Pokémon> de W N'.",
		pp: 29,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm16: {
		...
		name: "TM16",
		shortDesc: "Does nothing.",
		desc: "A replica of the Generation 1 glitch move 0xD8. Cartridge effect: None. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm17: {
		...
		name: "TM17",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xD9. Cartridge effect: None. Its real type is the glitch type 'Qi JT<name of player>? POké BB<name of Pokémon> de W N'. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm18: {
		...
		name: "TM18",
		shortDesc: "User cannot move next turn.",
		desc: "A replica of the Generation 1 glitch move 0xDA. Cartridge effect: The user must recharge the next turn.",
		pp: 46,
		noPPBoosts: true,
		priority: 0,
		flags: { recharge: 1, protect: 1, mirror: 1, metronome: 1 },
	...
	tm19: {
		...
		name: "TM19",
		shortDesc: "Raises the user's evasiveness by 2 stages.",
		desc: "A replica of the Generation 1 glitch move 0xDB. Cartridge effect: Increases the user's Evasion by two stages.",
		pp: 50,
		noPPBoosts: true,
		priority: 0,
		flags: { snatch: 1, metronome: 1 },
	...
	tm20: {
		...
		name: "TM20",
		shortDesc: "Does nothing.",
		desc: "A replica of the Generation 1 glitch move 0xDC. Cartridge effect: None.",
		pp: 10,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm21: {
		...
		name: "TM21",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xDD. Cartridge effect: Freezes the game unless it faints the target. Only the damage is simulated here. Its real type is the glitch type 'None'. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm22: {
		...
		gen: 1,
		name: "TM22",
		shortDesc: "Does damage equal to half the target's current HP.",
		desc: "A replica of the Generation 1 glitch move 0xDE. Cartridge effect: Does damage equal to half the target's HP. Its real type is the glitch type 'None'.",
		pp: 20,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm23: {
		...
		name: "TM23",
		shortDesc: "User recovers 50% of the damage dealt.",
		desc: "A replica of the Generation 1 glitch move 0xDF. Cartridge effect: Drains half the damage it inflicts. Its real type is the glitch type 'None'.",
		pp: 4,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, heal: 1 },
	...
	tm24: {
		...
		desc: "A replica of the Generation 1 glitch move 0xE0. Cartridge effect: Has a 30% chance to paralyze the target. Its real type is the glitch type 'None'. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm25: {
		...
		name: "TM25",
		shortDesc: "Does nothing.",
		desc: "A replica of the Generation 1 glitch move 0xE1. Cartridge effect: No additional effect. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm26: {
		...
		name: "TM26",
		shortDesc: "Does nothing.",
		desc: "A replica of the Generation 1 glitch move 0xE2. Cartridge effect: None. Its real type is the glitch type 'None'. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm27: {
		...
		gen: 1,
		name: "TM27",
		shortDesc: "Raises the user's Attack by 2 stages.",
		desc: "A replica of the Generation 1 glitch move 0xE3. Cartridge effect: Raises the user's Attack by two stages.",
		pp: 3,
		noPPBoosts: true,
		priority: 0,
		flags: { snatch: 1, metronome: 1 },
	...
	tm28: {
		...
		desc: "A replica of the Generation 1 glitch move 0xE4. Cartridge effect: Has a 30% chance of lowering the target's Special stat. If the move hits, the user's sprite disappears. In Yellow: Bug-type with 30 PP. Its real type is the glitch type '[Name of last Trainer battled] (RB) / Bug (Yellow)'.",
		pp: 54,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm30: {
		...
		name: "TM30",
		shortDesc: "Does nothing.",
		desc: "A replica of the Generation 1 glitch move 0xE6. Cartridge effect: None.",
		pp: 20,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm31: {
		...
		name: "TM31",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xE7. Cartridge effect: None.",
		pp: 40,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm32: {
		...
		name: "TM32",
		shortDesc: "User is hurt if it misses.",
		desc: "A replica of the Generation 1 glitch move 0xE8. Cartridge effect: When this attack misses, the user takes half damage.",
		pp: 52,
		noPPBoosts: true,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, metronome: 1 },
	...
	tm33: {
		...
		name: "TM33",
		shortDesc: "User recovers 50% of the damage dealt.",
		desc: "A replica of the Generation 1 glitch move 0xE9. Cartridge effect: Drains half the damage it inflicts.",
		pp: 49,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, heal: 1 },
	...
	tm34: {
		...
		name: "TM34",
		shortDesc: "Does nothing.",
		desc: "A replica of the Generation 1 glitch move 0xEA. Cartridge effect: None.",
		pp: 10,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm35: {
		...
		gen: 1,
		name: "TM35",
		shortDesc: "Raises the user's Defense by 2 stages.",
		desc: "A replica of the Generation 1 glitch move 0xEB. Cartridge effect: Doubles the user's Defense, as Reflect. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { snatch: 1, metronome: 1 },
	...
	tm36: {
		...
		name: "TM36",
		shortDesc: "Does damage equal to half the target's current HP.",
		desc: "A replica of the Generation 1 glitch move 0xEC. Cartridge effect: Does damage equal to half the target's HP. Its real type is the glitch type 'None'.",
		pp: 60,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm37: {
		...
		name: "TM37",
		shortDesc: "30% chance to poison the target.",
		desc: "A replica of the Generation 1 glitch move 0xED. Cartridge effect: Has a 30% chance of poisoning the target. Its real type is the glitch type 'None'.",
		pp: 60,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm38: {
		...
		name: "TM38",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xEE. Cartridge effect: Freezes the game unless it faints the target. Only the damage is simulated here. Its real type is the glitch type 'None'. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm39: {
		...
		name: "TM39",
		shortDesc: "User recovers 50% of the damage dealt.",
		desc: "A replica of the Generation 1 glitch move 0xEF. Cartridge effect: Drains half the damage it inflicts.",
		pp: 21,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, heal: 1 },
	...
	tm40: {
		...
		desc: "A replica of the Generation 1 glitch move 0xF0. Cartridge effect: Raises the user's Speed by one stage.",
		pp: 63,
		noPPBoosts: true,
		priority: 0,
		flags: { snatch: 1, metronome: 1 },
	...
	tm41: {
		...
		name: "TM41",
		shortDesc: "Raises the user's evasiveness by 2 stages.",
		desc: "A replica of the Generation 1 glitch move 0xF1. Cartridge effect: Raises the user's Evasion by two stages. Its real type is the glitch type 'x v zA'.",
		pp: 2,
		noPPBoosts: true,
		priority: 0,
		flags: { snatch: 1, metronome: 1 },
	...
	tm42: {
		...
		name: "TM42",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xF2. Cartridge effect: Freezes the game unless it faints the target. Only the damage is simulated here.",
		pp: 34,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm43: {
		...
		name: "TM43",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xF3. Cartridge effect: Scatters coins twice the value of the user's level, as Pay Day. Only the damage is simulated here.",
		pp: 3,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm44: {
		...
		name: "TM44",
		shortDesc: "User recovers 50% of the damage dealt.",
		desc: "A replica of the Generation 1 glitch move 0xF4. Cartridge effect: Drains half the damage it inflicts. Its real type is the glitch type 'None'.",
		pp: 12,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, heal: 1 },
	...
	tm45: {
		...
		name: "TM45",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xF5. Cartridge effect: None. Its real type is the glitch type '8 8 9 5'.",
		pp: 18,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm46: {
		...
		desc: "A replica of the Generation 1 glitch move 0xF6. Cartridge effect: Has a small chance (the Gen 1 33% effect class) to lower the target's Speed.",
		pp: 58,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm47: {
		...
		name: "TM47",
		shortDesc: "30% chance to poison the target.",
		desc: "A replica of the Generation 1 glitch move 0xF7. Cartridge effect: Has a 30% chance to poison the target. / Lowers a glitched stat with a random name. Its real type is the glitch type 'Cooltrainer♂'.",
		pp: 16,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm49: {
		...
		name: "TM49",
		shortDesc: "Raises the user's Defense by 2 stages.",
		desc: "A replica of the Generation 1 glitch move 0xF9. Cartridge effect: Doubles user's defense, identical to Reflect. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { snatch: 1, metronome: 1 },
	...
	tm50: {
		...
		desc: "A replica of the Generation 1 glitch move 0xFA. Cartridge effect: Attacks two to five times in a row. Its real type is the glitch type 'Glitch'.",
		pp: 25,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm51: {
		...
		name: "TM51",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xFB. Cartridge effect: None. Its real type is the glitch type 'Glitch'.",
		pp: 49,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm52: {
		...
		name: "TM52",
		shortDesc: "Raises the user's Defense by 2 stages.",
		desc: "A replica of the Generation 1 glitch move 0xFC. Cartridge effect: Doubles user's Defense, identical to Reflect. / Displays the message “But nothing happened.”, and then restarts the game in a glitch dimension. Its real type is the glitch type 'Blank'. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { snatch: 1, metronome: 1 },
	...
	tm53: {
		...
		name: "TM53",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xFD. Cartridge effect: None. Its real type is the glitch type '/6!2?2 A'.",
		pp: 30,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
	...
	tm54: {
		...
		name: "TM54",
		shortDesc: "User gains 1/2 of the damage inflicted. Sleeping target only.",
		desc: "A replica of the Generation 1 glitch move 0xFE. Cartridge effect: Drains HP from a sleeping foe, identical to Dream Eater.",
		pp: 62,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, heal: 1 },
	...
	tm55: {
		...
		name: "TM55",
		shortDesc: "No additional effect.",
		desc: "A replica of the Generation 1 glitch move 0xFF. Cartridge effect: None. Its real type is the glitch type 'x v Z A'. Has 0 PP on cartridge (unusable without PP Ups).",
		pp: 5,
		noPPBoosts: true,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1 },
